...
Napi::String Up(const Napi::CallbackInfo& info) {
//
...
return Napi::String::New(env, "Up");
}

Napi::String Down(const Napi::CallbackInfo& info) {
//
// info에는 현재 스코프 정보(env)도 들어있습니다.
// 자바스크립트 객체를 생성하려면 반드시 이것부터 가져와야합니다.
Napi::Env env = info.Env();
...
// 현재 스코프 정보(env)와 std::string을 사용하여,
// "Hi!"라는 자바스크립트 문자열을 반환합니다.
return Napi::String::New(env, "Down");
}
...
Napi::Object init(Napi::Env env, Napi::Object exports) {
  ...
  exports.Set(Napi::String::New(env, "Up"), Napi::Function::New(env, Up));

  exports.Set(Napi::String::New(env, "Down"), Napi::Function::New(env, Down));
  //
  // 다 집어넣었다면 반환합니다.
  return exports;
};
